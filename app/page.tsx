      ...
      <header id="hdr" style={{position:"fixed",top:"0",left:"0",right:"0",zIndex:"90",transition:"background .35s ease,box-shadow .35s ease"}}>
        <div style={{maxWidth:"1240px",margin:"0 auto",display:"flex",alignItems:"center",gap:"26px",padding:"13px clamp(16px,4vw,32px)"}}>
          ...
          <nav id="nav-links" style={{display:"flex",gap:"24px",marginLeft:"auto",fontWeight:"700",fontSize:"15px"}}>
            <a href="#usluge">Usluge</a><a href="#o-nama">O doktoru</a><a href="#radno-vrijeme">Radno vrijeme</a><a href="#recenzije">Recenzije</a><a href="#kontakt">Kontakt</a>
          </nav>
          ...
          <div style={{display:"flex",gap:"clamp(32px,5vw,64px)",flexWrap:"wrap",alignItems:"flex-start"}}>
            <div style={{flex:"1 1 320px",minWidth:"280px"}}>
              ...
              <div style={{display:"flex",gap:"10px",marginTop:"22px",flexWrap:"wrap"}}>
                ...
                <a href="viber://chat?number=%2B38737514771" style={{border:"2px solid rgba(245,240,232,.4)",color:"#F5F0E8",fontWeight:"800",fontSize:"14px",padding:"10px 18px",borderRadius:"999px",transition:"transform .3s cubic-bezier(.34,1.56,.64,1)"}} className="hv10">Viber</a>
                <a href="https://wa.me/38737514771" style={{border:"2px solid rgba(245,240,232,.4)",color:"#F5F0E8",fontWeight:"800",fontSize:"14px",padding:"10px 18px",borderRadius:"999px",transition:"transform .3s cubic-bezier(.34,1.56,.64,1)"}} className="hv10">WhatsApp</a>
                <a href="https://www.facebook.com/" target="_blank" rel="noopener" style={{display:"inline-flex",alignItems:"center",gap:"8px",border:"2px solid rgba(245,240,232,.4)",color:"#F5F0E8",fontWeight:"800",fontSize:"14px",padding:"10px 18px",borderRadius:"999px",transition:"transform .3s cubic-bezier(.34,1.56,.64,1)"}} className="hv10"><svg viewBox="0 0 24 24" style={{width:"15px",height:"15px"}}><path d="M13.5 21v-7.4h2.5l.4-2.9h-2.9V8.85c0-.84.23-1.41 1.44-1.41h1.54V4.85c-.27-.04-1.18-.11-2.24-.11-2.22 0-3.74 1.35-3.74 3.83v2.14H8v2.9h2.45V21h3.05Z" fill="#F5F0E8"></path></svg>Facebook</a>
              </div>
            </div>
